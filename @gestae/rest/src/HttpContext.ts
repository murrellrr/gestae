...
export class DefaultHttpContext extends Context implements IHttpContext {
 ...
 * @returns 
 */
export function createHttpContext(context: IApplicationContext, request: http.IncomingMessage, 
                                  response: http.ServerResponse, logger: ILogger): IHttpContext {
    return new DefaultHttpContext(context, request, response, logger);
}